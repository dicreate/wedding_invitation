   ...
   const questions: questionsItem[] = [
      {
         ...
         text: <div className={style.textContainer}>
            ...
            <p>Что касается мужчин, то наш взгляд упал на безупречность костюма <span style={{ fontWeight: 'bold' }}>любого цвета</span> – будь то элегантное сочетание рубашки и пиджака или же костюм, дополненный лишь рубашкой.</p>
